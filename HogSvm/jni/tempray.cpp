...
JNIEXPORT void Java_com_example_opencv_PreviceGray_grayProc(JNIEnv* env, jclass obj, jlong imageGray,jint touch_x,jint touch_y){
	int width,height;
    int k = 0,n = 0,i,j;
    CvScalar s;
...
JNIEXPORT void JNICALL Java_org_opencv_samples_tutorial2_Tutorial2Activity_grayProc_0(JNIEnv* env, jclass obj, jlong imageGray, jlong tempGray )
{
